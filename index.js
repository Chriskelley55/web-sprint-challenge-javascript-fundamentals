...
// Even though the variable internal is defined in the outer scope, it can still be accessed in the inner scope since the functions are nested.   
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const lowPopulationAnimals = array.reduce(function(item){
      return item.population ([i] < 5);
    })
    return lowPopulationAnimals
  }
